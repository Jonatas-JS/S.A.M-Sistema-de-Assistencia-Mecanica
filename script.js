function darkMod() {
  ...
  if (checkbox.checked) {
    ...
    document.querySelector('img-history-ticket-svg').classList.add('darkMod')
    document.querySelector('img-contacts-svg').classList.add('darkMod')
    document.querySelector('.logo-svg').classList.add('darkMod')
    document.querySelector('.abrir-detalhes-svg').classList.add('darkMod')
  } else {
    ...
    document.querySelector('.img-history-svg-ticket.darkMod').classList.remove('darkMod')
    document.querySelector('.img-contacts-svg.darkMod').classList.remove('darkMod')
    document.querySelector('.logo-svg.darkMod').classList.remove('darkMod')
    document.querySelector('.abrir-detalhes-svg.darkMod').classList.remove('darkMod')
  }
}
